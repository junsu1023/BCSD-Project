...
class EquipmentRepositoryImpl(private val warehouseDataSource: WarehouseDataSource): EquipmentRepository {
    override fun insertEquipmentData(equipmentData: EquipmentData) {
        warehouseDataSource.insertEquipmentData(equipmentData.mapToEntity())
    }

    override fun deleteEquipmentData(position: Int) {
        warehouseDataSource.deleteEquipmentData(position)
    }

    override fun getEquipmentListData(position: Int): Flow<List<EquipmentData>> {
